const Rules = ({ openRules, setOpenRules }) => {
  return (
    <div className={`overlay ${openRules ? "overlay__active" : ""}`}>
      <div className={`rules ${openRules ? "rules__active" : ""}`}>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="304" height="270">
            <defs>
              <linearGradient id="a" x1="50%" x2="50%" y1="0%" y2="100%">
                <stop offset="0%" stopColor="#FFF" stopOpacity=".097"></stop>
            ...
            <g fill="none" fillRule="evenodd">
              ...
              <g fill="#B1B4C5" transform="matrix(-1 0 0 1 177 39)">
                ...
                <path d="M41.963 2.015l8.59 8.728c.716.727.71 1.896-.013 2.616a1.833 1.833 0 01-2.6-.013l-8.59-8.728a1.855 1.855 0 01.013-2.616 1.833 1.833 0 012.6.013z"></path>
                <path d="M39.35 19.382l8.59-8.728a1.833 1.833 0 012.6-.013c.723.72.729 1.889.013 2.616l-8.59 8.728a1.833 1.833 0 01-2.6.013 1.855 1.855 0 01-.013-2.616z"></path>
              </g>
              <g
                fill="#B1B4C5"
        ...
        <div className="close_btn" onClick={() => setOpenRules(false)}>
